...
export default function Statistical() {
    ...
    const productChartData = {
        labels: ["Tổng sản phẩm hạt giống", "Tổng sản phẩm trồng trọt", "Tổng sản phẩm của nhà máy chế biến"],
    ...
    const listStatistical =
        currentUser.system_role === "ADMIN"
            ? [
                  {
                      icon: <FontAwesomeIcon size={"4x"} icon={faUsers} style={{color: "#3e74d0"}} />,
                  ...
                  //Product
                  {
                      icon: <FontAwesomeIcon size={"4x"} icon={faLeaf} style={{color: "#b8d818"}} />,
                  ...
                  {
                      icon: <FontAwesomeIcon size={"4x"} icon={faSeedling} style={{color: "#1aa231"}} />,
                  ...
                  {
                      icon: <FontAwesomeIcon size={"4x"} icon={faCloudSun} style={{color: "#afca2b"}} />,
                  ...
                  {
                      icon: <FontAwesomeIcon size={"4x"} icon={faArrowUpFromWaterPump} style={{color: "#515358"}} />,
    ...
    const fetchStatisticalSystems = async () => {
        await instanceAxios
        .get(`${currentUser.system_role === "ADMIN" ? "user/statistical" : "user/statistical/me"}`)
        .then((res) => {
        ...
        <div className="w-full pb-[50px]">
            <div className="w-full flex justify-around flex-wrap gap-5">
                {listStatistical.map((item, index) => (
                    <div key={index} className="flex w-1/4 gap-x-5 items-center p-[20px] bg-green-100 rounded-xl">
                        <div>
                ...
                <div className={"w-full flex gap-5 mt-10"}>
                    <div className="w-[50%] bg-[#f6f6f6] rounded-3xl border  p-5">
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <h2 className={"font-bold text-2xl text-center"}> Nội dung thông báo</h2>
                        </div>
                    ...
                    <div className="w-[50%] bg-[#f6f6f6] items-center border justify-center gap-2 rounded-3xl p-5">
                        <div className="flex items-center justify-center gap-2">
                            <FontAwesomeIcon width={36} height={36} className="w-8 h-8" icon={faClipboardList} />
                            <h2 className={"font-bold text-2xl text-center"}> Hoạt động gần đây</h2>
                        </div>
